...
- Cognitive warfare: Widely acknowledged methods include propagating information that exploit cognitive biases, emotionally influencing target identity/sub-identity through various mediums like news, mass media.
  ...
  - We [discussed here](identity.md) that identity(two traits) is critical basis for social collaboration, group behaviour and, biological competition hence regardless of the phase of warfare, identity is the core component at play.
  ...
  - PsyOps: Unlike psy warfare tactics which are always deployed through the info system/media, ops are devised according to latest system state developments or to achieve specific objective to sustain broader design plan.
    ...
    - Activity roles: Attempting explanation of roles using lever mechanism analogy(performed on non-military/civilian personnel).
      - Pivot:
        ...
        - Subject to extreme mental stress, induced mental disorders and loneliness. Indirect physical health damage.
