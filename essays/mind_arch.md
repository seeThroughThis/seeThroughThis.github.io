...
- As seen in *C1*, contemplating over existing memories, data will lead to same response from evolutionary components *C2*. In this is case, critical thinking can be more effective due to absence of environmental constraints.