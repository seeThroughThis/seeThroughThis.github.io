...
- This remains important throughout adult life to build advanced behaviour and habits shaped by how social system incentivises the its components. People's behaviour is not just driven by direct feedbacks but also perceived patterns about what behaviour leads to higher rewards, especially by behviour of high rank personalities in social hierarchies where large population observers often fall victim to heuristic pattern learning (shallow copying) e.g. following trends even if economically nonviable.