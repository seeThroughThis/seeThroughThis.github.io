...
- It’s crucial that positive acknowledgements/complements and negative acknowledgements/penalties are delivered with high accuracy by the environment for respective actions (correct data labelling). Depending on severity and combination type of desynchronisation between behaviour and environmental feedback can lead to a fragmented cognitive model, including emotional response, over/under confidence, polarised personality/moods.
