...
- SIS—dominantly mass media— acts as medium for implementation/occurence of [identity wiring]({% link essays/weaponisation.md %}#identity-wiring), execution of [identity fishing]({% /essays/weaponisation.md %}#identity-fishing).
